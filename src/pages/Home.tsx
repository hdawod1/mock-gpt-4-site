...
const Home: React.FC = () => {
    return (
        <div className='home-container flex flex-col md:flex-row items-center text-white w-[75%] h-[90%] m-auto'>
            <div className='home-left-content w-[45%] h-auto'>
                <p className='lg:text-6xl text-3xl text-[#F49867]'>Let's Build Something amazing with GPT-4 OpenAI</p>
